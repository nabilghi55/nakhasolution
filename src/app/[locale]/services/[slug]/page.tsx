          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white mb-6 md:mb-8">
                  {t("whyChoose")}
                </h2>
                <div className="space-y-4 md:space-y-6">
                  {service.features.map((feature: string, idx: number) => (
                    <div key={idx} className="flex items-start gap-4 p-5 md:p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all">
                      <div className="bg-blue-600 rounded-lg p-1 text-white shrink-0 mt-1">
                        <CheckCircle2 size={16} className="md:w-[18px] md:h-[18px]" />
                      </div>
                      <span className="text-base md:text-lg font-semibold text-slate-700 dark:text-slate-200 leading-tight">
                        {feature}
                      </span>
                    </div>
                  ))}
              ...
              >
                <div className="bg-slate-900 dark:bg-blue-900/10 rounded-[32px] md:rounded-[40px] p-8 md:p-12 text-white border border-white/10 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-400 dark:text-slate-300 text-base md:text-lg mb-8 md:mb-10 leading-relaxed">
                      {t("consultDesc")}
                    </p>
                    <a
                    ...
                    <div className="mt-8 md:mt-12 pt-8 md:pt-12 border-t border-white/10 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
