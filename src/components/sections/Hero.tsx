      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-3xl lg:text-5xl font-black text-slate-900 dark:text-white leading-[1.2] mb-6 tracking-tight flex flex-col">
              <span className="mb-2">{t("titlePrefix")}</span>
              <span className="text-blue-600 dark:text-blue-500 w-full block">
                <TypewriterEffect />
              </span>
            </h1>
            ...
            <div className="mt-16 flex items-center space-x-8">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-full border-4 border-white dark:border-slate-950 overflow-hidden bg-slate-200"
                  >
                    <Image
